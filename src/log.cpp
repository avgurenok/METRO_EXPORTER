...
#if LOG_OUTPUT_TO_FILE
    //#NOTE_SK: flush on every line - an unflushed log is useless exactly when it matters,
    //          which is when the app went down before it could close the file
    sLogFile << result << std::flush;
#endif
}
